...
if __name__ == "__main__":
    ...
    # lfh_base_path = rospack.get_path('lfh_inference')
    # launch_file = join(lfh_base_path, 'launch/lfh_controller.launch')
    
    lfh_base_path = rospack.get_path('LfH')
    launch_file = join(lfh_base_path, 'nav_competition_icra2022.launch')
